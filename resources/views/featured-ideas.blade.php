...
@section('bg_image', 'featured-ideas-page')
...
@section('content')
    <div class="row">
        ...
        <div v-else class="col-12 col-sm-12 offset-sm-2 col-md-7 offset-md-1 col-lg-7 offset-lg-1" style="display:none" :style="loading == true ? 'display:none' : 'display:block'">
...
@section('customJS')
    ...
    <script>
			...
			const app = new Vue({
				...
				methods: {
					getIdea() {
						axios.get('/secure/dashboard/all-featured-ideas-published').then((response) => {
