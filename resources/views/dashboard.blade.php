    ...
    <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                    <div class="col-card-design-blue">
                        <div class="card card-design-blue">
                            <div class="row">
                                <div class="col-12 col-sm-5 col-md-5 col-lg-5 column-01-wrapper">
                                    <div class="column-01">{{ $totalIdeasCount }}</div>
                                    <!-- /.column-01 -->
                                </div>
                                <!-- /.col-12 col-sm-4 col-md-4 col-lg-4 -->

                                <div class="col-12 col-sm-7 col-md-7 col-lg-7 column-02-wrapper">
                                    <div class="row">
                                        ...
                                        <div class="col-9 col-sm-9 col-md-9 col-lg-9">
                                            <div class="column-02">No. of Idea submitted</div>
                                            <!-- /.column-02 -->
                                        </div>
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                    <div class="col-card-design-purple">
                        <div class="card card-design-purple">
                            <div class="row">
                                <div class="col-12 col-sm-5 col-md-5 col-lg-5 column-01-wrapper">
                                    <div class="column-01">{{ $featuredIdeas->count() }}</div>
                                    <!-- /.column-01 -->
                                </div>
                                <!-- /.col-12 col-sm-4 col-md-4 col-lg-4 -->
                                ...
                                <div class="col-12 col-sm-7 col-md-7 col-lg-7 column-02-wrapper">
                                    <div class="row">
                                        ...
                                        <div class="col-9 col-sm-9 col-md-9 col-lg-9">
                                            <div class="column-02">No. of Featured ideas</div>
                                            <!-- /.column-02 -->
                                        </div>
                                        <!-- /.col-8 col-sm-8 col-md-8 col-lg-8 -->
                                    </div>
                            ...
                            <ul class="list-unstyled recent-ideas-module pt-0 pb-1" v-for="(idea, index) in ideas" :key="index">
                                <li class="media hr pb-0 mb-2 mt-2">
                                    ...
                                    <div class="media-body recent-ideas-idea-description">
                                        ...
                                        <p style="color: #414141;display:inline" :id="idea.id+'viewMoreText'">@{{ idea.elevator_pitch | truncate(160, '...') }}</p><br>
                                        <p style="color: #414141;display:none" :id="idea.id+'viewLessText'">@{{ idea.elevator_pitch }}</p><br>
                                        ...
                                        <div class="row" style="display: flex; font-size: 11px;">
                                            <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                                                <div>
                                                    ...
                                                    <span v-if="isLiked(idea.likes, {{Auth::user()->id}})">
                                                        <img :id="idea.id" @click="like(idea.id);" src="{{ asset('img/like.svg') }}" class="like-btn" height="16" alt="">
                                                    </span>
                                                    <span v-else>
                                                        <img :id="idea.id+'-grey'" @click="like(idea.id)" src="{{ asset('img/like_gray.svg') }}" class="like-btn"  height="16" alt="">
                                                    </span>
                                                </div>
                                            </div>
                                           ...
                                           <div v-if="idea.elevator_pitch.length > 160"
                                                ...
                                                <div class="text-right">
                                                    <div class="text-right">
                                                        <a :id="idea.id+'viewMore'" style="display:inline" @click="seeMoreOrLess(idea.id+'viewMore', idea.id)" class="view-more-button">See More</a>
                                                        <a :id="idea.id+'viewLess'" style="display:none" @click="seeMoreOrLess(idea.id+'viewLess', idea.id)" class="view-more-button">See Less</a>
                                                    </div>
                                                </div>
                                                <!-- /.text-right -->
                                            </div>
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-6">
            <div class="row mb-3">
                <div class="col-12 col-sm-12 col-sm-12 col-lg-12">
                    <div class="card card-shadow p-3">
                        <h5 class="text-deep-purple mb-0">Featured Ideas &nbsp;&nbsp;&nbsp;<span class="badge badge-purple badge-pill">{{ App\Idea::whereIsActive(1)->whereIsSubmitted(1)->whereIsFeatured(1)->whereIsApproved(1)->count() }}</span>
                        </h5>
                        <hr class="hr">
                                                    ...
                                                    <li class="media hr pb-0 mb-2 mt-2">
                                                        ...
                                                        <div class="media-body recent-ideas-idea-description">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12 col-sm-4 col-md-4 col-lg-4 text-right">
                                                                    <small class="recent-ideas-idea-published-time" style="color: #B9B9B9;">{{ Carbon\Carbon::parse($featuredIdea->submitted_at)->diffForHumans() }}</small>
                                                                </div>
                                                                <!-- /.col-12 col-sm-4 col-md-4 col-lg-4 -->
                                                            </div>
                                                            <!-- /.row -->
            ...
            @else
                <div class="row mb-3">
                    <div class="col-12 col-sm-12 col-sm-12 col-lg-12">
                        <div class="card card-shadow p-3">
                            <h5 class="text-deep-purple font-weight-bold mb-0">MY IDEAS &nbsp;&nbsp;&nbsp;<span class="badge badge-purple badge-pill">{{ App\Idea::whereUserId(auth()->id())->count() }}</span>
                            </h5>
                            <hr class="hr">
