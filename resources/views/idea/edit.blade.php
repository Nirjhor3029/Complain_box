        ...
        <div class="col-12 col-sm-10 col-md-9 offset-md-1 col lg-9 offset-lg-1">
            ...
            <div class="row">
                <div class="form-group col-12 col-sm-6 col-md-6 col-lg-6">
                    ...
                    {!! Form::text('title', $idea->title, ['class' => 'form-control custom-form-control', 'required']) !!}
                </div>
                <!-- /.form-group col-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                <div class="form-group col-12">
                    ...
                    {!! Form::textarea('elevator_pitch', $idea->elevator_pitch, ['class' => 'form-control custom-form-control custom-form-control-text-area', 'rows' => '3', 'required']) !!}
                </div>
                <!-- /.form-group col-12 -->
            </div>
            <!-- /.row -->
