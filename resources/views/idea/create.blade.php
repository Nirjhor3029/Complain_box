        ...
        <div class="col-12 col-sm-10 col-md-9 offset-md-1 col lg-9 offset-lg-1">
            ...
            <div class="row">
                <div class="form-group col-6">
                    {!! Form::label('file', 'Upload Files (Document/ Video): MAX_LIMIT- 70MB', ['class' => 'font-weight-bold custom-form-control-label']) !!}
                    {{-- {!! Form::file('file', ['class' => 'form-control-file custom-form-control']) !!} --}}
                    <div>Upload Limit left: <span style="color: purple;font-weight:bold" id="uploadLimit"></span></div><br>
                    <div class="field_wrapper">
                    <div>
                        <div class="row">
                            <div class="col-md-6">
                                <input type="file" id="upload_form" class="form-control-file custom-form-control" name="image[]" value=""/>
                                <input type="text" id="uploaded_file_id" hidden class="form-control-file custom-form-control" name="uploaded_file_id" value=""/>
                                <input type="text" id="idea_id" hidden readonly class="form-control-file custom-form-control" name="idea_id" value=""/>
                            </div>
                            {{-- <div class="col-md-4">
                                    <a href="javascript:void(0);" class="add_button" title="Add field" style="visibility: hidden"><i class="fa fa-plus"></i></a>
                            </div> --}}
                            <div style="width:200px; background-color: cornflowerblue" id="progress-wrp"><div class="progress-bar"></div ><div class="status">0%</div></div>
                        </div>
                    </div>
                    </div>
                </div>
