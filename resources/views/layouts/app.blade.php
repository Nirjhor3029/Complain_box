        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav justify-content-end d-flex flex-fill">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('dashboard.all-idea') }}" class="nav-link"><span
                                    @if (request()->is('secure/dashboard/all-idea')) class="border-bottom-custom" @endif>All Ideas</span></a>
                    </li>
                    <!-- /.nav-item -->

                    <li class="nav-item">
                        <a href="{{ route('dashboard.featured-ideas') }}" class="nav-link"><span
                                    @if (request()->is('secure/dashboard/featured-ideas')) class="border-bottom-custom" @endif>Featured Ideas</span></a>
                    </li>
                    <!-- /.nav-item -->
