...
@section('content')
    <div class="row py-3">
        <div class="col-12 col-sm-10 col-md-6 offset-md-1 col-lg-6 offset-lg-1 p-5" style="-webkit-box-shadow:0 0 10px 2px rgba(0,62,145,0.15);-moz-box-shadow:0 0 10px 2px rgba(0,62,145,0.15);box-shadow:0 0 10px 2px rgba(0,62,145,0.15);">
            {!! laraflash()->render() !!}

            @include('errors.validation')

            {!! Form::open(['route' =>'dashboard.update-my-profile-form', 'method' => "POST", 'files' => 'true', 'id'=>'form']) !!}

            <div class="mb-4">
                <div class="image_container">

                    @if (count($image) > 0 && $image[0]->profile_picture != "")
                        <img class="image rounded-circle" id="profile-pic" src="{{ url($image[0]->profile_picture) }}" width="120" height="120" alt="">
                    @else
                        <img class="image rounded-circle" id="profile-pic" src="{{ asset('img/profile-picture-placeholder.svg') }}" width="120" height="120" alt="">
                    @endif

                    <div class="middle">
                        <div class="imgbtn_text">
                            <img src="{{ asset('img/photo-camera.svg') }}" class="upload-button" height="30" alt="">
                            <button style="display: none;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalLong"></button>
            ...
            <div class="row">
                <div class="form-group col-sm-6 col-md-6 col-lg-6">
                    {!! Form::label('team') !!}
                    {!! Form::select('team', ['Dhaka Region' => 'Dhaka Region','Chittagong Region' => 'Chittagong Region','Khulna Region' => 'Khulna Region','Sylhet Region' => 'Sylhet Region','Rajshahi Region' => 'Rajshahi Region','Activation' => 'Activation','Business Development' => 'Business Development','Brands' => 'Brands','SP&I' => 'SP&I','Marketing Finance' => 'Marketing Finance','Marketing HR' => 'Marketing HR','MSD' => 'MSD'] , auth()->user()->team , ['title' => 'Select Team', 'required']) !!}
                </div>
                <!-- /.form-group col-4 -->
            ...
            <a href="{{ route('dashboard.my-profile') }}" class="btn btn-primary ml-3">Back to My Profile</a>
            <!-- /.btn btn-primary -->
